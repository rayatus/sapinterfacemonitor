"! <p class="shorttext synchronized" lang="en">DB Framework for: ZINTFMONITOR011</p>
CLASS zcl_zintfmonitor011_read DEFINITION
  PUBLIC
  CREATE PRIVATE .

  PUBLIC SECTION.
*"* public components of class ZCL_ZINTFMONITOR011_READ
*"* do not include other source files here!!!
    ...
    CLASS-METHODS save_list
      ...
      RAISING
        cx_db2_not_found .
  PROTECTED SECTION.
*"* protected components of class ZCL_ZINTFMONITOR011_READ
*"* do not include other source files here!!!
  PRIVATE SECTION.
*"* private components of class ZCL_ZINTFMONITOR011_READ
*"* do not include other source files here!!!
